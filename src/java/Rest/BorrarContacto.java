...
public class BorrarContacto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BorradoServicio bc = new BorradoServicio();
...
//            out.println("<body>");
            ...
            bc.putXml(nombre, idA, token);
//            out.println("El usuario " + nombre + " se ha borrado correctamente");
//            out.println("<h1>Servlet BorrarContacto at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
   // }
